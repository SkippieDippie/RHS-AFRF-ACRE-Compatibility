class AMMO_CLASS(765x17_Basic_1Rnd) : CVO_GreenMag_Ammo_Core_1Rnd {
	displayName = __EVAL(format [LSTRING(Ammo_Basic_in_Name), ".320ACP", 1]);
	descriptionShort = __EVAL(format [LSTRING(Ammo_Basic_in_Desc), ".320ACP"]);
...
class AMMO_CLASS(765x17_Basic_10Rnd) : CVO_GreenMag_Ammo_Core_10Rnd {
	displayName = __EVAL(format [LSTRING(Ammo_Basic_in_Name), ".320ACP", 10]);
...
class AMMO_CLASS(765x17_Basic_20Rnd) : CVO_GreenMag_Ammo_Core_20Rnd {
	displayName = __EVAL(format [LSTRING(Ammo_Basic_in_Name), ".320ACP", 20]);
...
class AMMO_CLASS(765x17_Basic_30Rnd) : CVO_GreenMag_Ammo_Core_30Rnd {
	displayName = __EVAL(format [LSTRING(Ammo_Basic_in_Name), ".320ACP", 30]);
...
class AMMO_CLASS(765x17_Basic_40Rnd) : CVO_GreenMag_Ammo_Core_40Rnd {
	displayName = __EVAL(format [LSTRING(Ammo_Basic_in_Name), ".320ACP", 40]);
...
class AMMO_CLASS(765x17_Basic_50Rnd) : CVO_GreenMag_Ammo_Core_50Rnd {
	displayName = __EVAL(format [LSTRING(Ammo_Basic_in_Name), ".320ACP", 50]);
...
class AMMO_CLASS(765x17_Basic_60Rnd) : CVO_GreenMag_Ammo_Core_60Rnd {
	displayName = __EVAL(format [LSTRING(Ammo_Basic_in_Name), ".320ACP", 60]);
